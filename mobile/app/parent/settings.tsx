...
export default function ParentSettings() {
  ...
  const handleResetJourney = async () => {
    ...
    try {
      ...
      if (res.success) {
        await AsyncStorage.removeItem("studysaathy_fuel");
        await AsyncStorage.removeItem("studysaathy_coins");
        await AsyncStorage.removeItem("studysaathy_level");
        await AsyncStorage.removeItem("studysaathy_completed_chapters");
        await AsyncStorage.removeItem("studysaathy_badges");
