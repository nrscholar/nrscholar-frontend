  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed top-4 left-1/2 -translate-x-1/2 z-[9999] max-w-md w-[92%] bg-gradient-to-r from-[#141779] via-[#1E2266] to-[#2D328F] text-white p-4 rounded-2xl shadow-[0_12px_30px_rgba(20,23,121,0.5)] border-2 border-[#57fae9] flex items-center gap-3 select-none"
      >
